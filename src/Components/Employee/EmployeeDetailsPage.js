...
import { Card, CardContent, Typography, Grid, CardMedia, Button, Snackbar } from '@mui/material';
...
const handleDelete = (e) => {
  e.preventDefault();
  axios.delete(`http://localhost:8081/api/deleteActive/${employeeId}`, employee)
    .then(response => {
       console.log('Employee deleted successfully:', response.data); 
        setOpenSnackbar(true);
        setSuccessMessage('Employee deleted successfully');
       setTimeout(()=>
       {setIsDeleted(true);},2000);  
      })
    .catch(error => {
...
<div className='head'> <h2>Employee Detail Page</h2>  
